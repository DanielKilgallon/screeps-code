const PRIORITY = [STRUCTURE_SPAWN, STRUCTURE_TOWER, STRUCTURE_CONTAINER, STRUCTURE_EXTENSION, STRUCTURE_STORAGE, STRUCTURE_LINK, STRUCTURE_WALL, STRUCTURE_RAMPART, STRUCTURE_ROAD];
